...
second is deduped by the content guard (c58: the two writes straddle
the close-out work, so their TIMESTAMPS differ while the counts are
identical -- the old same-timestamp claim was wrong; production
census 2026-09-18: 20/20 continuo closes double-wrote before the
fix), parseable and harmless; USAGE censuses must dedupe (c14 law).
