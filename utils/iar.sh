...
build_podman_args() {
    ...
    echo \
        ...
        $([[ -n "${NUM_PREDICT}" ]] && echo "-e EMACBOROS_NUM_PREDICT=${NUM_PREDICT}") \
...
Failures: ${FAILURES}"
    ...
    # Pull BEFORE assembly (relay 0034, session XV ratified):
    # prompt assembly reads this checkout at cycle start -- a stale
